...
import { Form, TextArea, FileCondition,TextInputLabel,InputItem,TextInput,SubmitBtn } from "../styled-components/post-tweet-styled-components"
...
const Inner2= styled.div`
   ...
   margin-top: 30px;
`
export default function ReplyModal({onClose,profileImg,userName,updatedDate,tweet}){
    ...
    ({
        ...
        async function handleSubmit(e:React.FormEvent<HTMLFormElement>){
            ...
            if(!user|| post.isLoading  || post.tweet.length>100  || post.tweet.trim()==='')return;
                ...
                <Inner1>
                    ...
                    <Inner2>
                                ...
                                <Form onSubmit={handleSubmit}>
                                        <TextArea placeholder='Post your reply' maxLength={100}  autoFocus onChange={handleChange} value={post.tweet} required/>
